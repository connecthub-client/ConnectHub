...
- **Frontend automated test suite** — component/store tests to complement `tsc --noEmit`; the Rust backend has unit tests plus an in-process test-SSH-server suite for session/sftp/exec.
